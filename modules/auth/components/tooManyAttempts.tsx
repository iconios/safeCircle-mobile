        ...
        <View style={[styles.contentContainer, { maxWidth: MAX_WIDTH }]}>
          ...
          <View style={styles.iconContainer}>
            ...
            >
              <View style={styles.iconInnerCircle}>
                <MaterialIcons name="lock-clock" size={40} color="#f20d0d" />
              </View>
            </Animated.View>
          </View>

          {/* Headline */}
          <Text style={styles.headline}>Too many attempts</Text>

          {/* Description */}
          <Text style={styles.description}>
            For security, please wait 15 minutes before trying again. We've
            temporarily paused verification for this number.
          </Text>

          {/* Timer Card */}
          <View style={styles.timerCard}>
            <Text style={styles.timerLabel}>You can try again in</Text>
            <View style={styles.timerDisplay}>
              <Animated.View style={{ transform: [{ rotate: spin }] }}>
                <MaterialIcons name="hourglass-top" size={20} color="#f20d0d" />
              </Animated.View>
          ...
          <View style={styles.actionsContainer}>
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <MaterialIcons name="support-agent" size={20} color="#f20d0d" />
              <Text style={styles.buttonSupportText}>Contact Support</Text>
            </TouchableOpacity>
          </View>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Text style={styles.footerLinkText}>Return to Login</Text>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
    </Animated.View>
